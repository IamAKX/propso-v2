...
server {
    ...
    # Your SSL certificates (if using Let's Encrypt/Certbot)
    ssl_certificate /etc/letsencrypt/live/propso.in/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/propso.in/privkey.pem;
